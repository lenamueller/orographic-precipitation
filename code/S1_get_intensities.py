...
def get_intensities(my_config, min_dry_period, min_event_length):
    ...
    print("Number of stations:", len(stations_all), "Number of OWK days:", len(owk_all))
    ...
    print("S1_read_intensites.py done")